            ...
            {achievements.map((achievement, index) => (
              ...
              >
                ...
                >
                  ...
                  {achievement.image ? (
                    ...
                    <div className="flex h-full w-full items-center justify-center bg-gradient-to-br from-violet-500/10 to-purple-500/10">
                      <Trophy
                        size={55}
                        className="text-violet-400 transition-colors duration-300 group-hover:text-violet-500"
                      />
                    </div>
                  )}
                ...
                <div className="relative p-6">
                  ...
                  {/* Date */}
                  <div className="mt-3 flex items-center gap-2 text-xs text-gray-500 transition-colors duration-300 group-hover:text-violet-600 dark:text-gray-500 dark:group-hover:text-violet-400">
                  ...
                  {/* Description */}
                  <p className="mt-4 line-clamp-2 text-sm leading-6 text-gray-600 transition-colors duration-300 group-hover:text-gray-700 dark:text-gray-400 dark:group-hover:text-gray-300">
                  ...
                  <button
                    ...
                    className="mt-6 inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-violet-600 to-purple-600 px-4 py-2.5 text-sm font-semibold text-white shadow-[0_0_20px_rgba(139,92,246,0.2)] transition-all duration-300 hover:scale-105 hover:shadow-[0_0_30px_rgba(139,92,246,0.4)]"
                  >
                    View Achievement
